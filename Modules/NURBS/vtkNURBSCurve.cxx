...
vtkStandardNewMacro(vtkNURBSCurve);
 ...
 * @return
 */
void vtkNURBSCurve::PrintSelf(ostream& os, vtkIndent indent)
{
 ...
 * @return
 */
vtkNURBSCurve* vtkNURBSCurve::GetData(vtkInformation* info)
{
  return info? vtkNURBSCurve::SafeDownCast(info->Get(DATA_OBJECT())) : 0;
}
 ...
 * @return
 */
vtkNURBSCurve* vtkNURBSCurve::GetData(vtkInformationVector* v, int i)
{
  return vtkNURBSCurve::GetData(v->GetInformationObject(i));
}
 ...
 * @return
 */
void vtkNURBSCurve::SetControlPoints(vtkPoints *points1d)
{
 ...
 * @return
 */
void vtkNURBSCurve::SetKnotVector(vtkDoubleArray *knotVector)
{
 ...
 * @return
 */
int vtkNURBSCurve::GeneratePolyDataRepresentation(const double spacing)
{
  ...
  vtkNURBSUtils::LinSpace(0, 1, numDiv, uEvals);
  ...
  for (int i=0; i<nCon; i++)
  {
    if (vtkNURBSUtils::BasisEvaluationVec(this->KnotVector, p,
                                       i, uEvals, Nus) != 1)
    {
      return 0;
    }
  ...
  if(vtkNURBSUtils::MatrixPointsMultiply(Nfinal, this->ControlPointGrid->GetPoints(),
                                       surfacePoints) != 1)
  {
    return 0;
  }
 ...
 * @return
 */
int vtkNURBSCurve::GetStructuredGridConnectivity(const int numPoints, vtkCellArray *connectivity)
{
  connectivity->Reset();
