...
int main(int argc, char *argv[])
{
  ...
  vtkSmartPointer<vtkMakeParametricCube>  Maker =
	  vtkSmartPointer<vtkMakeParametricCube>::New();

  std::string newDirName = getcwd(NULL, 0);
  system(("mkdir -p "+newDirName+"/Cube").c_str());
  //OPERATION
  ...
  //Write Files
  std::cout<<"Done"<<endl;
  WriteVTPFile(newDirName+"/Cube/Cube.vtp",  Maker->GetOutput(0),"_Test");
  vtkMakeParametricCube::WriteToGroupsFile(Maker->GetOutput(0), newDirName+"/Cube/testGroup");
