...
vtkStandardNewMacro(vtkSVBestFitPlane);

vtkSVBestFitPlane::vtkSVBestFitPlane()
{
  this->WeightMode = UNIFORMWEIGHT;
  this->GaussianVariance = 1.0;
}

double vtkSVBestFitPlane::WeightFunction(double distance)
{
...
int vtkSVBestFitPlane::RequestData(
...
int vtkSVBestFitPlane::FillInputPortInformation( int port, vtkInformation* info )
{
  if (port == 0)
    {
