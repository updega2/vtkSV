  ...
  vtkInformationVector *outputVector)
{
  ...
  metricArray->SetNumberOfTuples(numberOfInputCells);
  metricArray->FillComponent(0,0.0);

  output->GetCellData()->AddArray(metricArray);
