...
vtkBoundaryMapper::vtkBoundaryMapper()
{
...
int vtkBoundaryMapper::RequestData(vtkInformation *vtkNotUsed(request),
 ...
 * @return
 */
int vtkBoundaryMapper::PrepFilter()
{
 ...
 * @return
 */
int vtkBoundaryMapper::RunFilter()
{
...
int vtkBoundaryMapper::GetBoundaryLoop()
{
  vtkIdType nextCell;
 ...
 * @return
 */
int vtkBoundaryMapper::RunLoopFind(vtkPolyData *pd,
                                   vtkIdType startPt,
                                   vtkIdType nextCell,
                                   vtkPolyData *loop)
{
 ...
 * @return
 */
int vtkBoundaryMapper::CheckSurface(vtkPolyData *pd)
{
  pd->BuildLinks();
...
int vtkBoundaryMapper::CheckArrayExists(vtkPolyData *object,int datatype,std::string arrayname )
{
  vtkIdType i;
  int numArrays;
  int exists =0;
...
void vtkBoundaryMapper::PrintSelf(ostream& os, vtkIndent indent)
{
