...
int main(int argc, char *argv[])
{
  ...
  vtkSmartPointer<vtkBooleanOperationPolyDataFilterOld> myBoolean =
	  vtkSmartPointer<vtkBooleanOperationPolyDataFilterOld>::New();
#else
  ...
  double dummy[2];
  vtkIntersectionPolyDataFilterOld::CleanAndCheckSurface(fullpd,dummy,testTolerance);
